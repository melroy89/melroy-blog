...
Part I: Introducing to DNS, what is DNS? What are root servers? And does it work and what does it do and solve? Incl. some simple dig examples.
Explain most common DNS records. etc.
...
Test a domain name using the dig BIND tool (no worries works also fine WITHOUT using BIND😃):
