...
Query root level server for `.com`:

```sh
dig com. @a.root-servers.net.
```

What about quering name servers of google?

```sh
dig ns google.com
```

The additional section (`ADDITIONAL SECTION:`) actually shows the glue records of the name servers.
