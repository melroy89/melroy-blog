...
That being said, I didn't perform benchmarks across Redis and all their alternatives, so I can't come to any conclusions in terms of performance. I can only share the numbers I see from what I get from the Valkey benchmark tool for now:
