...
_Update:_ After a while trying to use Bun in several of my projects seems that Bun 1.x isn't as production ready as they might indicated it be. It's not compatible with multiple large Javascript frameworks like Fastify for instance.
